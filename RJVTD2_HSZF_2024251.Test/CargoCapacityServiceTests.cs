...
public class CargoCapacityServiceTests
{
    ...
    public void ReadAllCargoCapacities_ShouldReturnAllCargoCapacities()
    {
        var cargoCapacities = new List<CargoCapacity>
        {
            new CargoCapacity
            {
                Id = "125", Unit = "kg", Amount = 300, ShipmentId = "S125",
                Shipment = new Shipment { Id = "S125", ShipType = "Shipment125" }
            },
            new CargoCapacity
            {
                Id = "126", Unit = "kg", Amount = 400, ShipmentId = "S126",
                Shipment = new Shipment { Id = "S126", ShipType = "Shipment126" }
            }
        };
